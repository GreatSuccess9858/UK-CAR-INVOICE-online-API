...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'username', 'email', 'password', 'id_group', 'color','bnam','baddress','baddress2','city','county','postcode','businesspn','businessemail','vat','bownername','bownernum','user_logo_image','user_logo_mime',
    ];
