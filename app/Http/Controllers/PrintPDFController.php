...
class PrintPDFController extends Controller
{
	...
	{
        $data['user_own'] = User::find($sales->id_user);
		echo view('printpdf.invoice', compact(['sales', 'data']));
//
//		// clean up
...
//		}
	...
	public function email_invoice(Sales $sales)
	{
		...
		if ($client->client_email != NULL) {
			...
			Session::flash('flash_message', 'Sorry, we can not send email. Customer\'s email havent been set.');
			return redirect()->back();		// redirect back to original route
		}
	}
}