...
Route::get('sales/create', [
 ...
 Route::get('sales/create1', [
		'as' => 'sales.create1',
		'uses' => 'SalesController@create1'
	]);
...
// Route::get ('customers/edit2/{customer}', [
// 		'as' => 'customers.edit2',
// 		'uses' => 'CustomersController@edit2'
// 	]);
...
Route::get('customers/destroy/{customers}', [
