							...
							<div class = "col-sm-12">
								<div class="form-group">
									<label class="form-label">User:</label>
										...
										{!! Form::select('id_user', $k, @$value, ['data-placeholder' => 'Choose User', 'class' => 'form-select form-control form-control-lg', 'id' => 'us', 'data-search' => 'on' ]) !!}
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row gy-4">
							<div class="col-sm-4">
								<div class="form-group">
									...
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Invoice Number">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label class="form-label">Vehcile Reg</label>
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Vehcile Reg" value = "RSXEES">
									</div>
								</div>
								<div class="form-group">
									<label class="form-label">Make</label>
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Make" value = "Audi">
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									...
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Model" value = "Q7 TDI Sport">
									</div>
								</div>
								<div class="form-group">
									<label class="form-label">Colour</label>
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Colour" value = "Blue">
									</div>
								</div>
								<div class="form-group">
									<label class="form-label">Chassis Number</label>
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Chassis" value = "Wv3246Y78Y87989">
									</div>
								</div>
								<div class="form-group">
									<label class="form-label">Engine Number</label>
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Engine Number" value = "EN564Y88">
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								...
								<div class="form-group">
									...
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input Current Mileage" value = "102000">
									</div>
								</div>
								<div class="form-group">
									<label class="form-label">MOT Included</label>
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input MOT Included" value = "1">
									</div>
								</div>
								<div class="form-group">
									<label class="form-label">TAX Included</label>
									<div class="form-control-wrap">
										<input type="text" class="form-control-sm" placeholder="Input TAX" value = "3">
									</div>
								</div>
							</div>
						</div>
