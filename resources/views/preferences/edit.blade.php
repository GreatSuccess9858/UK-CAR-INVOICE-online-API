...
<div class="col-lg-12" style="margin-top:100px;">
	<div class="panel panel-default">
		<div class="nk-block-title page-title" style="font-size:30px; text-align:center;">Preference Option</div>
			<div class="panel-body" style="width:90%; margin-left:10%;">
				<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="form-group {!! ( count($errors->get('company_registration')) ) >0 ? 'has-error' : '' !!}">
								{!! Form::label('compregnum', 'Company Registration Number :', ['class' => 'col-sm-4 control-label']) !!}
								<div class="col-sm-10">
							...
							<div class="form-group {!! ( count($errors->get('logo.*')) ) >0 ? 'has-error' : '' !!}">
								...
								<div class="col-sm-10 col-sm-offset-2" style="border: 1px lightblue solid; width:150px; height:150px; padding-left: 0px; padding-right: 0px; margin-left: 15px;">
									<img src="data:{!! $preferences->company_logo_mime !!};base64,{!! $preferences->company_logo_image !!}"class="img-responsive img-rounded" style="">
								</div>
							</div>
							...
							<div class="form-group {!! ( count($errors->get('company_fixed_line')) ) >0 ? 'has-error' : '' !!}">
								{!! Form::label('cofixline', 'Fixed Line Phone Number :', ['class' => 'col-sm-4 control-label']) !!}
								<div class="col-sm-10">
							...
							<div class="form-group {!! ( count($errors->get('company_mobile')) ) >0 ? 'has-error' : '' !!}">
								{!! Form::label('compmobilephonenum', 'Mobile Number :', ['class' => 'col-sm-4 control-label']) !!}
								<div class="col-sm-10">
					...
					<!-- <div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group {!! ( count($errors->get('company_person_in-charge')) ) >0 ? 'has-error' : '' !!}">
								{!! Form::label('comppersonincharge', 'Company Person In-Charge :', ['class' => '']) !!}
								<div class="col-sm-8">
